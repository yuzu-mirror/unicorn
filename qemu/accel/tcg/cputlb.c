                            ...
                            bool is_softmmu_access)
{
    ...
    do_unaligned_access:
        addr1 = addr & ~(size - 1);
        addr2 = addr1 + size;
        r1 = load_helper(env, addr1, oi, retaddr, size, big_endian, code_read, is_softmmu_access);
        r2 = load_helper(env, addr2, oi, retaddr, size, big_endian, code_read, is_softmmu_access);
        shift = (addr & (size - 1)) * 8;
