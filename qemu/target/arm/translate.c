...
static void gen_ceq0_i32(TCGContext *s, TCGv_i32 d, TCGv_i32 a)
{
    tcg_gen_setcondi_i32(s, TCG_COND_EQ, d, a, 0);
    tcg_gen_neg_i32(s, d, d);
}

static void gen_ceq0_i64(TCGContext *s, TCGv_i64 d, TCGv_i64 a)
{
    tcg_gen_setcondi_i64(s, TCG_COND_EQ, d, a, 0);
    tcg_gen_neg_i64(s, d, d);
}

static void gen_ceq0_vec(TCGContext *s, unsigned vece, TCGv_vec d, TCGv_vec a)
{
    TCGv_vec zero = tcg_const_zeros_vec_matching(s, d);
    tcg_gen_cmp_vec(s, TCG_COND_EQ, vece, d, a, zero);
...
static void gen_cle0_i32(TCGContext *s, TCGv_i32 d, TCGv_i32 a)
{
    tcg_gen_setcondi_i32(s, TCG_COND_LE, d, a, 0);
    tcg_gen_neg_i32(s, d, d);
}

static void gen_cle0_i64(TCGContext *s, TCGv_i64 d, TCGv_i64 a)
{
    tcg_gen_setcondi_i64(s, TCG_COND_LE, d, a, 0);
    tcg_gen_neg_i64(s, d, d);
}

static void gen_cle0_vec(TCGContext *s, unsigned vece, TCGv_vec d, TCGv_vec a)
{
    TCGv_vec zero = tcg_const_zeros_vec_matching(s, d);
    tcg_gen_cmp_vec(s, TCG_COND_LE, vece, d, a, zero);
    tcg_temp_free_vec(s, zero);
}
...
static void gen_cge0_i32(TCGContext *s, TCGv_i32 d, TCGv_i32 a)
{
    tcg_gen_setcondi_i32(s, TCG_COND_GE, d, a, 0);
    tcg_gen_neg_i32(s, d, d);
}

static void gen_cge0_i64(TCGContext *s, TCGv_i64 d, TCGv_i64 a)
{
    tcg_gen_setcondi_i64(s, TCG_COND_GE, d, a, 0);
    tcg_gen_neg_i64(s, d, d);
}

static void gen_cge0_vec(TCGContext *s, unsigned vece, TCGv_vec d, TCGv_vec a)
{
    TCGv_vec zero = tcg_const_zeros_vec_matching(s, d);
    tcg_gen_cmp_vec(s, TCG_COND_GE, vece, d, a, zero);
    tcg_temp_free_vec(s, zero);
}
...
static void gen_clt0_i32(TCGContext *s, TCGv_i32 d, TCGv_i32 a)
{
    tcg_gen_setcondi_i32(s, TCG_COND_LT, d, a, 0);
    tcg_gen_neg_i32(s, d, d);
}

static void gen_clt0_i64(TCGContext *s, TCGv_i64 d, TCGv_i64 a)
{
    tcg_gen_setcondi_i64(s, TCG_COND_LT, d, a, 0);
    tcg_gen_neg_i64(s, d, d);
}

static void gen_clt0_vec(TCGContext *s, unsigned vece, TCGv_vec d, TCGv_vec a)
{
    TCGv_vec zero = tcg_const_zeros_vec_matching(s, d);
    tcg_gen_cmp_vec(s, TCG_COND_LT, vece, d, a, zero);
    tcg_temp_free_vec(s, zero);
}
...
static void gen_cgt0_i32(TCGContext *s, TCGv_i32 d, TCGv_i32 a)
{
    tcg_gen_setcondi_i32(s, TCG_COND_GT, d, a, 0);
    tcg_gen_neg_i32(s, d, d);
}

static void gen_cgt0_i64(TCGContext *s, TCGv_i64 d, TCGv_i64 a)
{
    tcg_gen_setcondi_i64(s, TCG_COND_GT, d, a, 0);
    tcg_gen_neg_i64(s, d, d);
}

static void gen_cgt0_vec(TCGContext *s, unsigned vece, TCGv_vec d, TCGv_vec a)
{
    TCGv_vec zero = tcg_const_zeros_vec_matching(s, d);
    tcg_gen_cmp_vec(s, TCG_COND_GT, vece, d, a, zero);
    tcg_temp_free_vec(s, zero);
}
    ...
    if ((insn & (1 << 23)) == 0) {
        ...
        if (size != 3) {
            ...
            if (!u) {
                ...
                case NEON_2RM_VCEQ0:
                    tcg_gen_gvec_2(tcg_ctx, rd_ofs, rm_ofs, vec_size,
